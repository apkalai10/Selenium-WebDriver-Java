...
public class Record {
	...
	public void SnapUsing(WebDriver driver)
	{
	...
	public void CaptureAnElement(WebDriver driver)
	{
		Calendar cal = Calendar.getInstance();
		Date time = cal.getTime();
		String sub  = RandomStringUtils.randomAlphabetic(4).toUpperCase();
	...
	public void fullcapture(WebDriver driver)
	{
		Calendar cal = Calendar.getInstance();
		Date time = cal.getTime();
		String sub  = RandomStringUtils.randomAlphabetic(4).toUpperCase();
	...
	public void ShootFull(WebDriver driver)
	{
		Calendar cal = Calendar.getInstance();
		Date time = cal.getTime();
		String sub  = RandomStringUtils.randomAlphabetic(4).toUpperCase();
	...
	public void ShootAnElement(WebDriver driver)
	{
		Calendar cal = Calendar.getInstance();
		Date time = cal.getTime();
		String sub  = RandomStringUtils.randomAlphabetic(4).toUpperCase();
